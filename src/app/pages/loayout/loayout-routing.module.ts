...
const routes: Routes = [
  ...
  // { path: '', redirectTo: 'select-school', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      // Allow optional reference number parameter using matrix or separate routes
      { path: 'first-screening', component: FirstScreeningComponent },
      { path: 'first-screening/:reference_number', component: FirstScreeningComponent },
      { path: 'participant-registration', component: FirstScreeningComponent },
